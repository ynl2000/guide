...
;(function ($, window) {
  ...
  (function (p) {
      ...
      p.setFixedContainerWidthForVisibleScrollArrows = function () {
       ...
       /*  20-05-13 二쇱꽍 stc.$fixedContainer.width(stc.fixedContainerWidth - stc.scrollArrowsCombinedWidth); */
      };
  ...
  var tabElements = (function () {
    ...
    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance, settings) {
      var $tabsContainer = $('<div class="scrtabs-tab-container"></div>'),
          leftArrowContent = settings.leftArrowContent || '<div class="scrtabs-tab-scroll-arrow scrtabs-tab-scroll-arrow-left"><i class="icon_left_arrow"><span class="blind">�댁쟾</span></i></div>',
          $leftArrow = $(leftArrowContent),
          rightArrowContent = settings.rightArrowContent || '<div class="scrtabs-tab-scroll-arrow scrtabs-tab-scroll-arrow-right"><i class="icon_right_arrow"><span class="blind">�ㅼ쓬</span></i></div>',
